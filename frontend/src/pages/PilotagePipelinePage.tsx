      ...
      <div className="space-y-6">
        ...
        <div className="bg-[var(--surface)] rounded-2xl border border-[var(--border)] shadow-lg p-6">
          ...
          <div className="flex items-center justify-between flex-wrap gap-4 mt-4">
            ...
            {pipelineMessage && (
              <p
                className={`text-sm font-medium ${pipelineMessage.type === "success"
        ...
        <div className="bg-[var(--surface)] rounded-2xl border border-[var(--border)] shadow-lg p-6">
          ...
          <div className="flex flex-wrap items-center gap-4 pt-4">
            ...
            {scrapeMessage && (
              <p
                className={`text-sm font-medium ${scrapeMessage.type === "success"
                    ? "text-green-600 dark:text-green-400"
                    : "text-red-600 dark:text-red-400"
                  }`}
              >
          ...
          <div className="p-4 space-y-2">
            ...
            {runs.map((run) => (
              <div
                ...
                className={`p-4 border rounded-2xl cursor-pointer transition-colors ${selectedRunId === run.id
